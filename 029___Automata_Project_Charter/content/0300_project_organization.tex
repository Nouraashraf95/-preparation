...
\midrule
Eng.\ Waleed Mostafa & Chief Director & Project Sponsor \\
\addlinespace
Dr.\ Hanaa Tharwat & System Administrator & Automata Project Manager \\
\bottomrule
\end{tabularx}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Eng.\ Waleed Mostafa (Chief Director, Automata)
    \end{itemize}
    \vspace{0.5em}
...
\begin{itemize}
    ...
    \end{itemize}
    \vspace{0.5em}
    \item \textbf{Automata SPOC (Dr.\ Hanaa Tharwat):}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Participates in change management and user adoption activities.
        \item Acts as a liaison between Automata users and the Scando technical team ``Scando SPOC''.
        \item Acts as the primary point of contact for Scando Integrated Solutions.
    \end{itemize}
    \vspace{0.5em}
    \item \textbf{Automata Team Members (All the employees):}
    \begin{itemize}
    ...
    \end{itemize}
    \vspace{0.5em}
    \item \textbf{Odoo Representative (Mr. Fouad Shaalan):}
    \begin{itemize}
        \item Provides advisory support and expertise on Odoo products and best practices.
        \item Assists in resolving technical issues related to Odoo software.
        \item Facilitates communication between Odoo and the project team as needed.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}[label=\textendash]
        \item \textbf{Critical} -- within 1 working day (or immediate workaround and escalation)
